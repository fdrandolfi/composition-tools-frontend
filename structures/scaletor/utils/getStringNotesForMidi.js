 ...
 * Starts from fret 1 (space 1), not fret 0 (open string tuning), as the open string is shown separately
 *
 ...
 * @returns {Array} The array of string notes [fret1, fret2, ..., fretN] (does not include fret 0/open string)
 */
